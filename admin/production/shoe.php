  ...
  <body class="nav-md">
    <div class="container body">
      <div class="main_container">
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="" class="site_title"><i class="fa fa-paw"></i> <span>HOME</span></a>
            </div>
        ...
        <a class="btn btn-primary" href="addShoe.php" role="button">New Toy</a>
          <table id="tableShoe">
            <tr>
              ...
              <th class="text-center" style="min-width:200px">Decription</th>
            ...
            <tr>
                ...
                <td><a class="btn btn-warning" href="updateShoe.php?id=<?php echo $shoe['shoe_id']?>" role="button">Edit</a></td>
                <td><a class="btn btn-danger" href="deleteShoe.php?id=<?php echo $shoe['shoe_id']?>" role="button" onclick="return confirm('You want to delete it?');">Delete </a></td>
            </tr>
            <?php
                  }
            ?>
